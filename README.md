...
- Скачай JSON-файл `cv_RU-expand` (ОН ТОЖЕ В РАЗРАБОТКЕ) и переименуй его в `cv_ru_RU.json` и закинь его по пути `папка игры\BepInEx\plugins\Assets\CasualtyVitals\`. ОС скажет, что файл с таким именем уже есть. Замени его
